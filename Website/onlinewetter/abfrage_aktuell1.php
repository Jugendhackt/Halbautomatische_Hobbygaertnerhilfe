...
$mysql_table3 = "wetter";
$sql = "SELECT p0, regen FROM ".$mysql_table3." ORDER BY datum3 DESC LIMIT 1";
...
echo '<table border=1 align=center>';	
	echo '<tr>';
	echo '<th align="center" width=300 height=25>Temperatur in &deg;C</th>';
	echo '<td align="center" width=200>' . $fetch4['Thof'] . '</td>';
	echo '<tr>';
	echo '<tr>';
...
echo '<tr>';
	...
	echo '<tr>';
	echo '<tr>';
		echo '<th align="center" height=30>Windst&auml;rke in Bft</th>';
if ($fetch1['ms'] < 0.3)
{
