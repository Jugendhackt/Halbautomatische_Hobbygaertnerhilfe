...
?></h1>
		...
		<tr width=180 height=3 style="border: none; padding: 0cm">
			<p align="left" style="page-break-before: always"><a href="links.php" target="links"><img src="images/button_diagramme.png" alt="Diagramme" /></a></p>
		</tr>
		<tr width=180 height=3 style="border: none; padding: 0cm">
			<p align="left" style="page-break-before: always"><a href="windspeed.php" target="main"><img src="images/button_windgeschwindigkeit.png" alt="Windgeschwindigkeit" /></a></p>
		</tr>
		<tr width=180 height=3 style="border: none; padding: 0cm">
			<p align="left" style="page-break-before: always"><a href="temperatur.php" target="main"><img src="images/button_temperatur.png" alt="Temperatur" /></a></p>
		</tr>
		<tr width=180 height=3 style="border: none; padding: 0cm">
			<p align="left" style="page-break-before: always"><a href="luftfeuchte.php" target="main"><img src="images/button_luftfeuchte.png" alt="Luftfeuchtigkeit" /></a></p>
		</tr>
		<tr width=180 height=3 style="border: none; padding: 0cm">
			<p align="left" style="page-break-before: always"><a href="niederschlag.php" target="main"><img src="images/button_niederschlag.png" alt="Niederschlag" /></a></p>
		</tr>
		<tr width=180 height=3 style="border: none; padding: 0cm">
			<p align="left" style="page-break-before: always"><a href="luftdruck.php" target="main"><img src="images/button_luftdruck.png" alt="Luftdruck" /></a></p>
		</tr>
		<tr width=180 height=3 style="border: none; padding: 0cm">
